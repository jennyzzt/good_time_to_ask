...
from projects.objectnav_baselines.models.object_nav_models import ResnetTensorObjectNavAskSegActorCritic
...
class FeedbackInstanceSegSensor(Sensor):
    def __init__(
        ...
        **kwargs: Any,
        ...
        observation_space = gym.spaces.Box(high=1, low=0, shape=(224, 224), dtype=np.float32)
        super().__init__(**prepare_locals_for_super(locals()))
    ...
    def get_observation(
        ...
        **kwargs: Any,
        ...
        if task._took_ask_action and task.task_info["object_id"] in env.last_event.instance_masks.keys():
...
class ObjectNaviThorRGBDPPOExperimentConfig(ExperimentConfig):
    ...
    @classmethod
    def tag(cls):
        return "Objectnav-askseg-iTHOR-RGBD-ResNetGRU-DDPPO"
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        ...
        return ResnetTensorObjectNavAskSegActorCritic(
